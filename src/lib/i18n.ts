...
export interface LanguagePack {
  ...
  /** Dynamic theme label based on mode: "light" | "dark" */
  getToggleThemeLabel: (mode: "light" | "dark") => string;
...
export const ui: Record<Locale, LanguagePack> = {
  he: {
    ...
    getToggleThemeLabel: (mode: "light" | "dark") =>
      mode === "dark" ? "מצב אור" : "מצב לילה",
